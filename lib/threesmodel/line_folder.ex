defmodule LineFolder do
  ...
  ## Examples
      ...
      iex> LineFolder.fold([0,0,0,0])
      [0,0,0,0]

      iex> LineFolder.fold([1,1,0,0])
      [1,1,0,0]
      ...
      iex> LineFolder.fold([0,1,2,0])
      [1,2,0,0]

      iex> LineFolder.fold([0,0,1,2])
      [0,1,2,0]

      iex> LineFolder.fold([1,2,0,0])
      [3,0,0,0]

      iex> LineFolder.fold([3,0,1,2])
      [3,1,2,0]

      iex> LineFolder.fold([3,1,0,2])
      [3,1,2,0]

      iex> LineFolder.fold([3,2,1,0])
      [3,3,0,0]

      iex> LineFolder.fold([3,3,0,0])
      [6,0,0,0]

      iex> LineFolder.fold([12,6,6,0])
      [12,12,0,0]

      iex> LineFolder.fold([12,12,3,3])
      [24,3,3,0]

      iex> LineFolder.fold([3,3,3,3])
      [6,3,3,0]

      iex> LineFolder.fold([3,1,1,3])
      [3,1,1,3]

      iex> LineFolder.fold([1,3,3,1])
      [1,6,1,0]

      iex> LineFolder.fold([1,2,1,2])
      [3,1,2,0]

      iex> LineFolder.fold([1,2,1,2])
      [3,1,2,0]

      iex> LineFolder.fold([1,2,0,3])
      [3,0,3,0]
  ...
  ## Examples
      ...
      iex> LineFolder.can_fold?([0,0,0,0])
      false

      iex> LineFolder.can_fold?([1,0,0,0])
      false

      iex> LineFolder.can_fold?([1,1,0,0])
      false

      iex> LineFolder.can_fold?([1,1,1,0])
      false

      iex> LineFolder.can_fold?([1,1,1,3])
      false

      iex> LineFolder.can_fold?([3,1,1,1])
      false

      iex> LineFolder.can_fold?([1,1,1,1])
      false

      iex> LineFolder.can_fold?([2,0,0,0])
      false

      iex> LineFolder.can_fold?([2,2,0,0])
      false

      iex> LineFolder.can_fold?([2,2,2,0])
      false

      iex> LineFolder.can_fold?([2,2,2,2])
      false

      iex> LineFolder.can_fold?([3,6,12,6])
      false

      iex> LineFolder.can_fold?([1,1,3,3])
      true

      iex> LineFolder.can_fold?([0,0,0,1])
      true
  """
